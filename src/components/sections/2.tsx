...
const features: Feature[] = [
  ...
  },
  {
    ...
    image: '/images/features/sifter-mesh.png',
  ...
  },
  {
    ...
    image: '/images/features/bearing-system.png',
  ...
  },
  {
    ...
    image: '/images/features/magnetic-alignment.png',
  ...
  },
  {
    ...
    image: '/images/features/adjustment-ring.png',
      ...
      <div className="w-full min-h-screen">
        {features.map((feature, index) => (
          ...
          >
            ...
            <div className="absolute inset-x-0 top-0 h-3/4 bg-gradient-to-b from-red-900/80 via-red-800/40 to-transparent z-10"></div>
            ...
            <div className="relative z-20 w-full max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
              ...
              <div className={`relative ${index % 2 === 0 ? 'lg:order-2' : 'lg:order-1'}`}>
                <div className="relative w-full h-56 md:h-64 lg:h-80 max-w-xs mx-auto">
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl flex items-center justify-center border border-red-900/30">
                    <div className="text-center space-y-4">
                      <div className="w-16 h-16 bg-red-900/50 rounded-full flex items-center justify-center mx-auto">
                        <span className="text-xl font-bold text-red-300">{feature.id}</span>
                      </div>
                      <p className="text-gray-400 text-sm">
                        Product Image: {feature.imageAlt}
                      </p>
